    ...
    basic.forever(function () {
        if (JOY_INIT == 1) {
            ...
            if (p2 > 717) {
                ...
                } else if (p1 >= 298 && p1 <= 717 && JOY_STATE != 2) {
                    control.raiseEvent(
                    EventBusSource.MES_DPAD_CONTROLLER_ID,
                ...
                if (p1 > 717 && JOY_STATE != 6) {
                    ...
                    JOY_STATE = 6
                    control.waitMicros(wait_time)
                } else if (p1 >= 298 && p1 <= 717 && JOY_STATE != 5) {
                    control.raiseEvent(
                    EventBusSource.MES_DPAD_CONTROLLER_ID,
                ...
                if (p1 > 717 && JOY_STATE != 9) {
                    ...
                    JOY_STATE = 9
                    control.waitMicros(wait_time)
                } else if (p1 >= 298 && p1 <= 717 && JOY_STATE != 8) {
                    control.raiseEvent(
                    EventBusSource.MES_DPAD_CONTROLLER_ID,
